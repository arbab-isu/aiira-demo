...
# The above function (not used) is to build the quick stats panel. The quick stats panel is the panel that contains the operator ID, time to completion, and the stop button.
        ...
        html.Div(
            ...
            children=[
                dash_player.DashPlayer(
                    id='video-player-1',
                    url='https://www.youtube.com/embed/DHUnz4dyb54?controls=0&showinfo=0&rel=0&modestbranding',  # Replace with your YouTube video url
                    controls=False,
                    playing=True,
                ...
                dash_player.DashPlayer(
                    id='video-player-2',
                    url='https://www.youtube.com/embed/DHUnz4dyb54?controls=0&showinfo=0&rel=0&modestbranding=1',  # Replace with your second YouTube video url
                    controls=False,
                    playing=True,
...
# These are the step to remove tabs from this app because there is only one tab anyway:
# 1. Remove the tabs from the app layout
# 2. Remove the callback for the tab content
